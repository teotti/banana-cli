...
collections an item's detail view can drill into (group details offer members,
expenses and activity), `runCli` fetches and cleans each one into a
`BrowserLevel`, and Esc pops back to the detail it was opened from.
