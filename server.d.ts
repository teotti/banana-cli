...
export declare const appType: Elysia<"", {
    ...
    store: {
        sessionUser: import("better-auth").User;
        session: null;
    };
    derive: {};
    resolve: {};
    ...
    macroFn: {
        readonly auth: {
            readonly resolve: ({ status, request: { headers }, store }: {
                body: unknown;
                ...
                status: <const Code extends number | keyof import("elysia").StatusMap, const T = Code extends 100 | 410 | 101 | 102 | 103 | 200 | 201 | 202 | 203 | 204 | 205 | 206 | 207 | 208 | 300 | 301 | 302 | 303 | 304 | 307 | 308 | 400 | 401 | 402 | 403 | 404 | 405 | 406 | 407 | 408 | 409 | 411 | 412 | 413 | 414 | 415 | 416 | 417 | 418 | 420 | 421 | 422 | 423 | 424 | 425 | 426 | 428 | 429 | 431 | 451 | 500 | 501 | 502 | 503 | 504 | 505 | 506 | 507 | 508 | 510 | 511 ? {
                ...
                readonly code: "GUEST_SESSION_FORBIDDEN";
                readonly message: "Guest sessions are not permitted. Verify ownership to claim this guest.";
            }, 403> | {
                sessionUser: Omit<{
                    id: string;
                    name: string;
